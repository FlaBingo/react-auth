                ...
                <table class="t39" role="presentation" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td width="400" class="t38"
                      style="background-color:#FFFFFF;border:1px solid #CECECE;overflow:hidden;width:400px;border-radius:20px 20px 20px 20px;">
                                    ...
                                    <tr>
                                      <td width="60" class="t3" style="width:60px;">
                                        <table class="t2" role="presentation" cellpadding="0" cellspacing="0"
                                          ...
                                          <tr>
                                            <td class="t1"><a href="#" style="font-size:0px;" target="_blank"><img
                                                  class="t0"
                                                  style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;"
                                                  width="60" height="60" alt=""
                                                  src="https://bdaf3e0e-a2da-4176-aad5-404e082dcb3d.b-cdn.net/e/1b782b99-27ba-4c84-abba-b41689ca6ba7/f32c9ba2-6426-42bc-81be-2c774d7c9627.png" /></a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                                  ...
                                  <table class="t22" role="presentation" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                      <td width="154" class="t21"
                                        style="background-color:#0057FF;overflow:hidden;width:154px;border-radius:8px 8px 8px 8px;">
                                        <table class="t20" role="presentation" cellpadding="0" cellspacing="0"
                                          width="100%" style="width:100%;">
                                          <tr>
                                            <td class="t19"
                                              style="text-align:center;line-height:40px;mso-line-height-rule:exactly;mso-text-raise:8px;">
                                              <a class="t17" href="#"
                                                ...
                                                target="_blank">{verificationCode}</a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                                  ...
                                  <table class="t34" role="presentation" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                      <td width="318" class="t33"
                                        style="background-color:#F2EFF3;overflow:hidden;width:420px;border-radius:8px 8px 8px 8px;">
                                        <table class="t32" role="presentation" cellpadding="0" cellspacing="0"
                                          width="100%" style="width:100%;">
                                          <tr>
                                            <td class="t31" style="padding:20px 30px 20px 30px;">
                                              <p class="t29"
                                                ...
                                                Email specialists use
                                                X&#39;s intuitive tool
                                                to design emails for
                                                desktop and mobile, and
                                                let our smart algorithm
                                                generate HTML for use in
                                                their ESPs.</p>
                                            </td>
                                          </tr>
                                        </table>
